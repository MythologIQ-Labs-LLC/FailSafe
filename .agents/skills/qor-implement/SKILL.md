...
Template: `.Codex/commands/references/qor-implement-patterns.md`.
...
```
ABORT
Report: "Intent lock missing or invalid. Run /qor-plan --lock first."
```
...
```
ABORT
Report: "Skill not admitted for current phase. Run /qor-research to admit."
```
...
Checklist: `.Codex/commands/references/qor-implement-patterns.md`.

#### Code Patterns

Reference code patterns:
`.Codex/commands/references/qor-implement-patterns.md`.
