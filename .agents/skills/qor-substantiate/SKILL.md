...
Template: `.Codex/commands/references/qor-substantiate-templates.md`.
...
If any skill files (`.Codex/commands/qor-*.md`) were modified during this session:
...
```
ABORT
Report: "Skill admission evidence check failed (B49). Re-run /qor-audit to re-verify."
```
