...
- **Release preflight now catches missing release notes locally.** The `[RELEASE]` commit hook fails when this README lacks the version's What's New section — the gap that previously surfaced only at CI. (FX917)
