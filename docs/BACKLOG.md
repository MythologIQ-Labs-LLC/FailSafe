...
| **v5.5.0**   | **Integration Suite**          | 🚀 RELEASING   | Integration suite expansion — governance hub for the whole AI toolchain. Governed CLI agent wrappers (Continue #104, Aider #107), agent observe/audit (OpenHands #105, Cline/Roo/Kilo #106), Linear #97 + Jira #98 issue→intent import, GitHub PR checks #96, Sentry #102, Teams #101, Playwright MCP, and a Tier 1 supply-chain CI baseline #90. Consolidated + VETO-remediated (4 external-name defects caught against live docs: Aider `--yes-always`, Sentry env-in-query, OpenHands real-SDK shape, Linear case-insensitive) + idle-scheduler de-flake. 15 per-integration READMEs + docs/structure indices; FEATURE_INDEX FX826–FX836. Squash-merged via PR #153; closes #90/#96/#97/#98/#101/#102/#104/#105/#106/#107. |
