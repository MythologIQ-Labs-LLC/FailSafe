...
| **v5.2.0**   | **FailSafe Learn**             | ✅ RELEASED    | Learn tab two-sub-tab redesign (Read sectioned essays + jump-strip + Copy template button; Glossary renamed + tag-filter UI + 48 SWE terms + Bicameral co-existence FX618), global a11y baseline (WCAG 2.3.3+2.4.7+1.4.4+1.4.3), Mindmap Ollama probe fix. META_LEDGER #392+#393. FX614-FX620. |
