...
| **v5.2.1**   | **FailSafe Learn (hotfix)**    | ✅ RELEASED    | First v5.2.x build to actually publish to VS Code Marketplace + Open VSX. Zero feature delta from v5.2.0 — same Learn tab rebuild, Ollama probe fix, a11y baseline. Drops 3 orphaned SHIELD-anchor lesson literals + stabilizes FX615 tag-filter test against re-render churn. META_LEDGER #395. |
