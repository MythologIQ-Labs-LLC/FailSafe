...
| **v5.4.0**   | **Integration Expansion**      | 🚀 RELEASING   | Integration + governance batch (33 commits). B-INT-8 research gate cleared (13 contract reviews). New governed integrations: SARIF ingestion + import command (#99, FX820/FX822), MCP Registry local risk scoring (#108, FX821), Slack notify-only governance notifications (#100, FX825), Context7 + Mermaid Chart MCP installers + Integrations → MCP Catalog tab (B-INT-13/14, FX823/FX824). Development Tracker v1 + v1.1 (evidence-enforced, console-hosted, FX817–FX819). Substrate: dependency-admission cooling-period lint (B-SUBSTRATE-2, FX814/FX815) + seal auto-hook (B-SUBSTRATE-3, FX816). B-BIC-24 idle-disconnect de-flake; qor-logic 0.102.1 sync. PRs #121–#132. |
