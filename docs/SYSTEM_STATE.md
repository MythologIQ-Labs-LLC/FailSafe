...
**Unreleased on `main` (since v5.6.3):** the tracker-as-governance-sidecar thread completed — META_LEDGER Entries #432–#438: A.2 sidecar emission (#194/FX865), A.1b plans→programs/phases (#195/#198/FX866), A.2b-data route projection + unanchored reconciliation (#203/FX867), verticals = the 7 Console surfaces (#204/FX868, drift-guarded), live `programs.yaml` accuracy + graceful no-server message (#205), FEATURE_INDEX `Surface` column + per-surface `featureStats` attribution (#206/FX869–871, upstream gate Qor-logic#196 — now SHIPPED in qor-logic 0.103.1 as the substantiate surface-tag lint), A.2b-visual render — coverage bar + unanchored-phase counting + manifestSource advisory (#202/FX872–874). All `--admin`-merged, CI green; #198/#202/#206 closed; #196/#197/#83 open. Not yet published — staged for the next release.
**Current Release:** v5.6.3 (DELIVER seal #431; published to VS Code Marketplace + Open VSX — four-feature governance bundle: #154 PR↔issue linkage auditor + live-wiring (FX861/FX864), tracker-as-governance-sidecar GovernanceProjection (FX862, A.1), shadow-genome causal-graph consumer (FX863, #118). Three views of the governance ledger. PRs #190/#191/#192 + release PR #193 `--admin`-merged; both publish jobs succeeded, production-gate approved; Build & Test passed first-run (FX525 de-flake held). Closes #154, #118. Deferred follow-ups #194–#198 filed. Research brief: `.failsafe/governance/research-brief-tracker-governance-sidecar-2026-06-06.md`.
